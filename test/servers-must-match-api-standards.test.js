    ...
    expect(res[0]).toMatchObject(
                          {
                            ...
                            message: "Schema and host in URL must match company API standards; url:https://app.bettercloud.com/ incorrect. Example: https://api.bettercloud.com/automation/v1",
                            path: ["servers", "url"],
                            severity: 0
                          }
                        );
